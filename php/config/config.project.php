...
const project_source_code_link = 'https://github.com/pigeonwilson/turbo-octo-lamp/tree/main/';
const project_source_code_license_link = 'https://github.com/PigeonWilson/turbo-octo-lamp/blob/main/LICENSE';
